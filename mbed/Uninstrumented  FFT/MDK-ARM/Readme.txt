This is the instrumented version of FFT.

This has two checkpoint calls. First at the start of the FFT function
Second before calling the four1 function second time.
