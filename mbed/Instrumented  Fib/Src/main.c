...
int fibonacci(int term){
    ...
    bp = sp;
		...
		FCN++;
		mem_map(&sp,sizeof(FCN));

		
		if(FCN==1 || FCN==1000000){
			...
			*/
				sprintf(string,"Starting First Checkpoint... \r\n"); 
				print(string);
			} else {
			/*
				Starting The Second Checkpoint here
				This will copy only the modified RAM to FLASH 
				since this is the second checkpoint
			*/
				sprintf(string,"Starting Second Checkpoint... \r\n");
				print(string);
			}
