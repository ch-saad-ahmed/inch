...
// Globals and Funcs
uint32_t A[2560]; // A ==> bit_array_map
...
#define ADDR_FLASH_PAGE_1345   ((uint32_t)0x08054100)// last page
...
#define FLASH_USER_END_ADDR         ADDR_FLASH_PAGE_1345
...
// RSA vars and funcs
long int p,q,n,t,flag,e[128],d[128],temp[128],j,m[128],en[128],i;
//char msg[20] = "Test message";
char msg[128] = "Middle Earth Shadow of Mordor Middle Earth Shadow of Mordor Middle Earth Shadow of Mordor Middle Earth Shadow of Mordor Mordor\n";
// char msg[128] = "JwN7ND2isPVUYVDZ3EAwAWEAWbGHQ6cH4V7Y9mSz3pIKQ0esBtHWiIh4YahY9XaNygBekGAM3VplJHfQI8Mb24li4kojAEIN3CgGophYOgLq75pRx8yO5xXj9pdWJm";
int prime( int);
void ce();
int cd(int);
void encrypt();
...
void ce()
{
    ...
    {   
        ...
        if(flag==1&&i!=p&&i!=q)
        {
            e[k]=i;
            flag=cd(e[k]);
            mem_map(&e[k],sizeof(e[k]));
            if(flag>0)
            {
                d[k]=flag;
                mem_map(&d[k],sizeof(d[k]));
                k++;
            }
...
void encrypt()
{
    ...
    while(i!=len)
    {
        ...
        en[i]=ct;
        i++;
        mem_map(&en[i],sizeof(en[i]));
        mem_map(&temp[i],sizeof(temp[i]));    
    }
...
{   
    ...
    mem_map(&sp,sizeof(sp));
        ...
        /*
            ...
            This will copysign the entire RAM to FLASH 
            since this is the firstCheckPoint checkpoint
        */
        ...
        p=17;//33637;//46639;//971;//3163;//41;//17;//1; //    191;//71;//1933;
    flag=prime(p);
    mem_map(&flag,sizeof(flag));
    mem_map(&p,sizeof(p));
    ...
    q =13;//10069;//13;//1049; 1871;//997;//2617;//3;//179;//67;//179;//67;//2617;
    mem_map(&q,sizeof(q));
    ...
    encrypt();
        ...
        /*
            ...
            This will copysign only the updated portion of RAM
            to FLASH since this is the firstCheckPoint checkpoint
        */
